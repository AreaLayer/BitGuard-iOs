...
import ios.app.KeyguardManager
import ios.content.Context
import ios.os.Build
import ios.util.Log
import ios.biometric.BiometricManager
import ios.biometric.BiometricManager.Authenticators.*
import ios.biometric.BiometricPrompt
import ios.core.content.ContextCompat
import ios.fragment.app.Fragment
import com.bitguard.R
import com.bitguard.data.SharedPreferencesManager.PREFS_PIN_ACTIONS_CONFIGURED
