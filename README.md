...
The RGB functionality is provided by [rgb-lib] via [rgb-lib-swift], while the
Bitcoin functionality is provided by [bdk-swift].
...
Once the code is ok, to build the release bundles for upload to the Apple Stre
run:
```bash
